...
export default function TestCard({ 
  id, title, type, duration, participants, difficulty, isPremium = false, progress = 0 
}: TestCardProps) {
  ...
  return (
    <div className="group bg-white rounded-2xl border border-slate-200 p-6 hover:shadow-lg hover:border-orange-200 transition-all flex flex-col h-full relative overflow-hidden">
      ...
      <div className="mt-auto">
        ...
        >
          {progress > 0 && progress < 100 ? "Davom ettirish" : progress === 100 ? "Natijani ko'rish" : "Testni boshlash"}
