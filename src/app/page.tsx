...
import { ArrowRight, CheckCircle2, Star, Trophy, Users, Zap } from "lucide-react";

export const metadata: Metadata = {
  title: "TezIELTS - O'zbekistondagi eng zamonaviy IELTS Mock platformasi",
  description: "AI orqali baholanadigan, rasmiy IELTS standartlariga to'liq javob beruvchi Mock testlar. Speaking va Writing xatolaringizni aniq bilib oling.",
  openGraph: {
    title: "TezIELTS - Premium Mock Tests",
    description: "AI orqali baholanadigan, rasmiy IELTS standartlariga to'liq javob beruvchi Mock testlar.",
    type: "website",
  }
};
  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden bg-white pt-24 pb-32">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-5xl md:text-7xl font-extrabold text-slate-900 tracking-tight leading-tight mb-8">
            IELTS da <span className="bg-gradient-to-r from-yellow-500 to-orange-600 bg-clip-text text-transparent">8.0+ Olish</span> Uchun <br className="hidden md:block" />
            Eng Zo'r Simulyator.
          </h1>
          
          <p className="max-w-2xl mx-auto text-xl text-slate-600 mb-12 leading-relaxed">
            Haqiqiy imtihon muhiti, kiritilgan audio va testlar. AI yordamida Speaking va Writing bo'yicha batafsil xatolar tahlili.
          </p>
      ...
      <section id="pricing" className="bg-white py-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl font-extrabold text-slate-900 mb-4">Sizga mos tarifni tanlang</h2>
          <p className="text-xl text-slate-500 mb-12">Yashirin to'lovlarsiz. Istalgan vaqtda bekor qilishingiz mumkin.</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto text-left">
            ...
            <div className="bg-white border-2 border-slate-100 rounded-3xl p-8 hover:border-slate-200 transition-colors">
              ...
              <div className="text-4xl font-extrabold text-slate-900 mb-6">Bepul</div>
              <ul className="space-y-4 mb-8">
                <li className="flex items-center gap-3 text-slate-600 font-medium"><CheckCircle2 className="text-green-500 w-5 h-5"/> 3 ta Mock Test</li>
                <li className="flex items-center gap-3 text-slate-600 font-medium"><CheckCircle2 className="text-green-500 w-5 h-5"/> Reading va Listening tahlili</li>
                <li className="flex items-center gap-3 text-slate-400 font-medium"><span className="w-5 h-5 flex items-center justify-center">-</span> Speaking va Writing AI yo'q</li>
              </ul>
              <Link href="/tests" className="block w-full text-center bg-slate-100 text-slate-900 font-bold py-3 rounded-xl hover:bg-slate-200 transition-colors">
                Boshlash
              </Link>
            </div>
            ...
            <div className="relative bg-slate-900 border-2 border-slate-900 rounded-3xl p-8 transform md:-translate-y-4 shadow-2xl">
              ...
              <div className="text-4xl font-extrabold text-white mb-6">99,000 <span className="text-lg text-slate-400 font-normal">so'm/oy</span></div>
              <ul className="space-y-4 mb-8">
                <li className="flex items-center gap-3 text-slate-300 font-medium"><CheckCircle2 className="text-orange-500 w-5 h-5"/> Barcha Mock Testlar</li>
                <li className="flex items-center gap-3 text-slate-300 font-medium"><CheckCircle2 className="text-orange-500 w-5 h-5"/> To'liq AI Baholash (Spk/Wrt)</li>
                <li className="flex items-center gap-3 text-slate-300 font-medium"><CheckCircle2 className="text-orange-500 w-5 h-5"/> Natijalar tarixi va progress</li>
              </ul>
